...
void afficher(image p, SDL_Surface *screen); void afficherButton(image A, SDL_Surface *s);
void initBackground(image *bg); void initBackground1(image *bg); void hotkBackground(image *bg); void fhotkBackground(image *bg);
void init_f_Background(image *backg); void init_f_Background1(image *backg);
