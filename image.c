...
{
	bg->img = IMG_Load("Pictures/Backgrounds/1.png");
...
{
	fbg->img = IMG_Load("Pictures/Backgrounds/1.png");
...
void afficher(image p, SDL_Surface *screen) //Function to show background on screen 
{
